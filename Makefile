...
#    Updated: 2021/04/03 10:55:35 by yait-el-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB = mlx/libmlx.a 
INC = inc/fractol.h  
SRC = src/main.c src/zoom.c src/mouse.c src/keys.c  src/mainv2.c src/ft_itoa.c src/ft_putstr.c src/ft_strcmp.c src/ft_putendl.c
